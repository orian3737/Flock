...
const formatCards = [
  ...
  { id: "pdf", label: "PDF", icon: FileText, deferred: true },
  { id: "xlsx", label: "XLSX", icon: Sheet, deferred: true },
];
      ...
      <aside className="export-config-panel">
        ...
        <div className="export-format-grid">
          {formatCards.map((card) => {
            ...
            return (
              <button
                className={format === card.id ? "selected" : ""}
                key={card.id}
                type="button"
              ...
              >
                ...
                {card.label}
                {card.deferred ? <span className="deferred-tag">soon</span> : null}
              </button>
            );
          })}
        </div>
